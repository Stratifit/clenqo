...
**Established by:** `openspec/archive/create-worker/` (implemented 2026-09-18, commit `772ff6c`; hosted Supabase verification 8/8 PASS, full hosted suite 73/73 PASS, local suite 264 PASS)
...
Cleaner execution PWA (Change 7), payment, payroll, notification delivery,
team cleaning, and automatic assignment remain outside this capability.
