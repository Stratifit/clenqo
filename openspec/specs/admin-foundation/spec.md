...
**Capability:** `admin-foundation`
**Status:** Active capability
**Established by:** `openspec/archive/create-admin-foundation/` (implemented 2026-09-19, commit `e0a619f`; hosted Change 8 verification 9/9 PASS, full hosted Changes 1–8 regression 89/89 PASS, local suite 313 PASS)
**Sources:** `ADMIN_SYSTEM.md` §3, `REQUIREMENTS.md` §28/§32, `SECURITY.md` §14, `BRANCH_SYSTEM.md` §22, `DATABASE.md` §11.1, `PROJECT_STRUCTURE.md`, `DOCUMENTATION_AUDIT.md` §4c, `ROADMAP.md`
...
acceptance criteria. The authoritative decision records are BD-A1–BD-A4 and
C8-1/C8-3. One `/admin` surface with a server-resolved organization/branch
context is the V1 routing model; slug-scoped `/<branch-slug>/admin`, branch
application intake (`/apply/branch`), public website rendering, CMS editors,
generic configuration-inheritance/policy engines, notification delivery,
payments, and multi-organization support remain outside this capability.
