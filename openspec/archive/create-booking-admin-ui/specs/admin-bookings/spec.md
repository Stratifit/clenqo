# admin-bookings — Change 9 capability delta

> Proposed delta for the staff-facing Booking + Customer Admin UI surface.
...
> this capability describes the application surface that consumes them.
